...
export const fetchRequestByUserId = async (id) => {
    try {
        const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/api/request/getDataByUserId/${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const updateRequest = async (formData) => {
    try {
        const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/api/request/${formData._id}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const deleteRequest = async (formData) => {
    try {
        const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/api/request/${formData._id}`, {
            method: 'DELETE',
            headers: {
