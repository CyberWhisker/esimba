    ...
    <LocalizationProvider dateAdapter={AdapterMoment}>
      <form style={{ width: '100%' }} onSubmit={handleSubmit}>
        <Stack direction={'column'} spacing={1}>
          ...
          <DatePicker label='Marriage Date' sx={{ width: '100%' }} name='marriageDate' onChange={value => handleDataDateChange('baptismDate', value)} />
          <TextField label="Partner Name" sx={{ width: '100%' }} name='partnerName' onChange={handleDataChange} />
          <Stack direction={'row'} spacing={2}>
          ...
          <Stack spacing={2} direction={'row'}>
            <TextField label='Sponsor Name' sx={{ width: '100%' }} name='witness1' onChange={handleDataChange} />
